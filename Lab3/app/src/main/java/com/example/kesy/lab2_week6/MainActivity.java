...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int index = random.nextInt(itemRecycleList.size());
        Intent intentBroadcast = new Intent(STATICACTION);
        Bundle bundle = new Bundle();
        bundle.putSerializable("itemBroadcast",itemRecycleList.get(index));
    ...
    public void handleEventBus(Item backItem){
    ...
    protected void onNewIntent(Intent intent) {
        ...
        Log.d("Receivemessage","resume+" +intent.getBooleanExtra("isClickedFloatingActionButton",false));
        if(intent.getBooleanExtra("isClickedFloatingActionButton",false)){
            floatingActionButton.setImageResource(R.drawable.mainpage);
            recyclerView.setVisibility(View.INVISIBLE);
            listView.setVisibility(View.VISIBLE);
            tag = 1;
